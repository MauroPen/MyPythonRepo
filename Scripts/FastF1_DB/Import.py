...
def import_sessions(fromYear = 1950, toYear = 2023, cachePath = '', importPractice = True, importQualifying = True, importRace = True):
    ...
    for year in range(fromYear, toYear + 1, 1):
        ...
        for round in range(1, max(calendar["RoundNumber"]), 1):     #Is it possible to reduce verbose logging?
